...
$(document).ready(function(e){
    ...
    let target = "{{ url('/get_orders_data') }}";
  ...
  columns: [
      ...
      "columnDefs": [
                ...
                "render": function(data, type, row) {
                    if( row["is_refund"]  == 1 ){
                        let inpt = "" ;
                        inpt += "<a href='javascript:void(0)'  data-id='" + row["id"] + "' class='btn  btn-info action_link accept' title='View Email Details' >Accept</a>";
                        return inpt;
                    }else if(row["is_refund"]  == 0){
                        let inpt = "" ;
                        inpt += "<button href='javascript:void(0)'  data-id='" + row["id"] + "' class='btn  btn-info action_link refund' title='View Email Details'  disabled >Placed</button>";
                        return inpt;
                    }
