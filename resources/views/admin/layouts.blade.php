        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div class="navbar-nav">
                <a class="nav-item nav-link active" href="/home">Dashboard <span class="sr-only">(current)</span></a>
                <a class="nav-item nav-link" href="/products">Manage Products</a>
                <a class="nav-item nav-link" href="/orders">Manage Orders</a>
                <a class="nav-item nav-link" href="/customers">Manage Customers</a>
