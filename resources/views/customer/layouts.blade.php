        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div class="navbar-nav">
                <a class="nav-item nav-link active" href="/profile">Dashboard <span class="sr-only">(current)</span></a>
                <a class="nav-item nav-link" href="/ordercoffee">Order</a>
                <a class="nav-item nav-link" href="/apply_refund">Apply for refund</a>
                <a class="nav-item nav-link"  href="/logout">Logout</a>
                
                {{-- <a class="nav-item nav-link disabled" href="/orders">Manage Customers</a> --}}
              </div>
            </div>
            <span class="badge badge-light ml-20">{{session('email')}}</span>
          </nav>
        </header>
